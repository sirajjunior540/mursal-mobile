...
- **Django Server**: `http://192.168.1.170:8000`
- **Tenant Host**: `sirajjunior.192.168.1.170`
...
curl -H "Host: sirajjunior.192.168.1.170" http://192.168.1.170:8000/api/v1/auth/

# Test with tenant header
curl -H "Host: sirajjunior.192.168.1.170" \
     -H "Content-Type: application/json" \
     http://192.168.1.170:8000/api/v1/delivery/
```
...
# Test Django server
curl -v -H "Host: sirajjunior.192.168.1.170" http://192.168.1.170:8000/
