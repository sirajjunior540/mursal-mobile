...
- **Current IP**: `192.168.1.167` (set in .env)
- **Server Port**: `8000`
- **Tenant**: `sirajjunior`
...
2. **Update Django settings.py:**
   ...
   ALLOWED_HOSTS = [
       'localhost',
       '127.0.0.1',
       '192.168.1.167',  # Your IP
       'sirajjunior.192.168.1.167',  # Tenant subdomain
...
3. **Run Django server:**
   ...
   python manage.py runserver 192.168.1.167:8000
   ```
