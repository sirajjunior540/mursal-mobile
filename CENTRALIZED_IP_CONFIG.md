...
- **Current IP**: `192.168.0.191` (set in .env)
- **Server Port**: `8000`
- **Tenant**: `sirajjunior`
...
2. **Update Django settings.py:**
   ...
   ALLOWED_HOSTS = [
       '192.168.0.191',
       '127.0.0.1',
       '192.168.0.191',  # Your IP
       'sirajjunior.192.168.0.191',  # Tenant subdomain
...
3. **Run Django server:**
   ...
   python manage.py runserver 192.168.0.191:8000
   ```
...
For Android emulator, the app automatically uses `192.168.0.191` when it detects:
- Platform is Android
- SERVER_IP is set to 192.168.0.191
