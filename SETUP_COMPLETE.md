...
- **Auto-detected your IP**: `192.168.1.50`
- **Multi-tenant support** with host header: `sirajjunior.192.168.1.50`
...
API_HOST=different_tenant.192.168.1.50
```
