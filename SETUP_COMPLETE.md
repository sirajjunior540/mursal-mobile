...
- **Auto-detected your IP**: `192.168.1.163`
- **Multi-tenant support** with host header: `sirajjunior.192.168.1.163`
...
WS_BASE_URL=ws://192.168.1.163:8000
...
API_HOST=different_tenant.192.168.1.163
```
