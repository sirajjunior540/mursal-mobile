...
- **Auto-detected your IP**: `192.168.1.170`
- **Multi-tenant support** with host header: `sirajjunior.192.168.1.170`
...
WS_BASE_URL=ws://192.168.1.170:8000
...
API_HOST=different_tenant.192.168.1.170
```
