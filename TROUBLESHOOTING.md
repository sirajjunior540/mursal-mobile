...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    '192.168.1.137',  # Your development machine IP
    'sirajjunior.192.168.1.137',  # Tenant host
...
curl -v -H "Host: sirajjunior.192.168.1.137" http://192.168.1.137:8000/health/

# Test auth endpoint
curl -v -H "Host: sirajjunior.192.168.1.137" \
     -H "Content-Type: application/json" \
     http://192.168.1.137:8000/api/v1/auth/
...
**Solution**: Add `192.168.1.137` and `sirajjunior.192.168.1.137` to ALLOWED_HOSTS
...
```
[API] GET http://192.168.1.137:8000/api/v1/auth/
[API] Host header: sirajjunior.192.168.1.137
