...
2. **Update your server IP:**
   ```bash
   # Edit .env file
   SERVER_IP=172.20.10.2  # Replace with your actual IP
   ```
...
SERVER_IP=172.20.10.2      # Your Django server IP
...
2. Update `.env`:
   ```env
   SERVER_IP=172.20.10.2  # Your actual IP
   ```
...
2. **"Network error. Cannot reach http://172.20.10.2:8000"**
