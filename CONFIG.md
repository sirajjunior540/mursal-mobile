...
2. **Update your server IP:**
   ```bash
   # Edit .env file
   SERVER_IP=192.168.1.163  # Replace with your actual IP
   ```
...
SERVER_IP=192.168.1.163      # Your Django server IP
...
2. Update `.env`:
   ```env
   SERVER_IP=192.168.1.163  # Your actual IP
   ```
...
2. **"Network error. Cannot reach http://192.168.1.163:8000"**
